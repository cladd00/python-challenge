...
file_path_5 = '~/Desktop/02-Homework/03-Python/Instructions/PyPoll/raw_data/election_data_1.csv'
file_path_6 = '~/Desktop/02-Homework/03-Python/Instructions/PyPoll/raw_data/election_data_2.csv'

data = pd.read_csv(file_path_6) 
