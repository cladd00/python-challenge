...
file_path_3 = '~/Desktop/02-Homework/03-Python/Instructions/PyBoss/raw_data/employee_data1.csv'
file_path_4 = '~/Desktop/02-Homework/03-Python/Instructions/PyBoss/raw_data/employee_data2.csv'


# employee_data1.csv & employee_data2.csv

data = pd.read_csv(file_path_4, parse_dates =["DOB"])

data[["First Name", "Last Name"]] = data["Name"].str.split(" ", expand = True) # seperate first and last name 
